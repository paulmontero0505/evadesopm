...
const isMultipurposeOperator = (member) => member.person_type === 'opm' && ['OPERARIO MULTIPROPOSITO', 'OPERARIO DE PUERTO MULTIPROPOSITO'].includes((member.puesto || '').trim().toUpperCase())
